    ...
    <div className="min-h-screen bg-[#0A0A0A] text-white p-6">
      <div className=" mx-auto grid grid-cols-12 gap-6">
        ...
        <div className="md:col-span-3 space-y-6">
          {/* My Stacks Section */}
          <motion.div className="bg-[#111111] p-6 rounded-2xl" {...fadeIn}>
        ...
        <div className="md:col-span-3 space-y-6">
          ...
          <div className="grid grid-cols-3 gap-4">
            <motion.div
              {...fadeIn}
              className="bg-[#111111] rounded-2xl p-3 space-y-5  flex-col justify-between items-center"
            >
              <div className=" flex justify-center items-center text-5xl font-bold text-center font-[montserrat] tracking-wide mx-auto">
                01<span className="text-purple-500 font-thin">+</span>
              </div>
              <div className="flex justify-center items-center gap-2 mb-2 mx-auto text-center">
                <span className="bg-purple-500/10 rounded-lg">
                  <svg
                    width="15"
                    height="15"
                    viewBox="0 0 24 24"
            ...
            >
              <div className=" flex justify-center items-center text-5xl font-bold text-center font-[montserrat] tracking-wide mx-auto">
                12<span className="text-purple-500 font-thin">+</span>
              </div>
            ...
            >
              <div className=" flex justify-center items-center text-5xl font-bold text-center font-[montserrat] tracking-wide mx-auto">
                03<span className="text-purple-500">+</span>
              </div>
              <div className="flex justify-center items-center gap-2 mb-2 mx-auto text-center">
                <span className="bg-purple-500/10 rounded-lg">
                  <svg
                ...
                <span className="text-gray-400 text-xs">Year Expertise</span>
              </div>
            </motion.div>
          </div>
            ...
            <div className="flex items-center gap-4 mb-4">
              ...
              <div>
                <div className="flex items-center gap-2">
                  ...
                  <button className="bg-[#1A1A1A] p-2 rounded-lg flex gap-2">
                    Resume
                    <svg
                      width="20"
                      height="20"
            ...
            <div className="space-y-4">
              <div className="p-4 bg-[#1A1A1A] rounded-xl">
                ...
                <p className="text-gray-300">
                  ...
                  incidunt tempor porttitor lectus.
                </p>
              </div>
              <div className="p-4 bg-[#1A1A1A] rounded-xl">
                <div className="flex items-center gap-3 mb-2">
